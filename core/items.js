...
add('potion',['Poção 50']);add('super-potion',['Poção 100']);add('hyper-potion',['Poção 200']);add('fresh-water',['Poção 30%']);add('moomoo-milk',['Poção 50% HP']);add('max-potion',['Poção 100% HP']);add('revive',['Revive']);
