...
async function mountEnvironmentAsset(key, placement) {
  ...
  try {
    ...
    root.position.set(placement[1], 0, placement[2]);
...
async function loadWorldAssetPack() {
  ...
  if (assetState.environmentLoaded >= minimumRemoteProps) {
    scene.traverse((object) => {
      if (object.userData && object.userData.proceduralLandscape) object.visible = false;
    });
...
window.PSY_WILDLANDS_3D_V154 = {
  version: 'WILDLANDS_3D_V154',
  state,
  actions: {
